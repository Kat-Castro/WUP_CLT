...
The graph shown above appears to be unimodal when it's around 9 samples. We have a bimodal distribution from the beginning to the end of the graphs where they are progressing towards the distribution of the unimodal.
...
```
The data presented above from the graph now looks more unimodal compared to before when having use of 16 samples averaged together.
...
Now with 25 samples averaged together, the graph appears to look more unimodal as it is compared to have smaller sample sizes analysised
...
As we went through the samples to represent the Central Limit Theorem, we were able to grasp a better understanding on how the models were used to analysis our samples. With the samples increasing, we began to see more graphs with an unimodal. Our sample of 36 gave us a graph that was averaged together with the most evenly distributed sample sizes that were given.
